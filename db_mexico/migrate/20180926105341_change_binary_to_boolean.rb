  ...
  def change
    reversible do |dir|
      dir.up do
        ...
        change_column :docindice_settings_temporalmente_nosegestionan, :voz, :boolean, default: false, null: false
        change_column :docindice_search, :hoja, :boolean, default: false, null: false
        change_column_null :novedad, :athome, false, 0 
        ...
        change_column_null :novedad, :to_latam, false, 0 
        change_column :novedad, :to_latam, :boolean, default: false, null: false
        change_column_null :novedad_historico, :athome, false, 0 
        ...
        change_column :usuario, :actualizaciones, :boolean, default: false, null: false
      ...
      dir.down do
        ...
        change_column :docindice_settings_temporalmente_nosegestionan, :voz, :binary, limit: 1, default: 0, null: false
        change_column :docindice_search, :hoja, :binary, limit: 1, default: 0, null: false
        ...
        change_column :novedad, :to_latam, :binary, limit: 1, default: 0, null: false
        ...
        change_column :usuario, :actualizaciones, :binary, limit: 1, default: 0, null: false
