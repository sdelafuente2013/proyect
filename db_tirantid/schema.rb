...
ActiveRecord::Schema.define(version: 20180528142704) do

  create_table "lopd_ambitos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci" do |t|
  ...
  create_table "lopd_apps", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci" do |t|
    t.string "nombre", limit: 200, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "lopd_temporal_users", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci" do |t|
    t.string "usuario", limit: 200, null: false
    t.string "email", limit: 200
  end

  create_table "lopd_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci" do |t|
    t.string "usuario", limit: 200, null: false
    ...
    t.datetime "fecha_aceptacion", null: false
    t.string "email", limit: 200
    ...
    t.index ["usuario", "lopd_ambito_id"], name: "index_lopd_users_on_usuario_and_lopd_ambito_id", unique: true
  end

  create_table "lopd_users_to_update", id: :integer, unsigned: true, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci" do |t|
    t.string "usuario", limit: 200, null: false
    t.string "email", limit: 200, default: "", null: false
    t.integer "subid", null: false
    t.bigint "lopd_ambito_id", null: false
    t.index ["usuario", "email", "subid"], name: "idx_usuario_email_subid"
  end
